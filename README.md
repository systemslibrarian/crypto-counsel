...
- **RAG-powered answers** — a local `corpus.json` (237 entries: 97 algorithms, 138 demo cards, 2 reference docs) is searched at query time with TF-IDF scoring and hand-tuned synonym expansion; the top matches are injected into the system prompt for grounded responses.
...
corpus.json         RAG corpus — 237 entries:
                      97 algorithm entries
                      136 crypto-lab demo cards + 2 standalone demos (snow2, dad-mode-morse2)
