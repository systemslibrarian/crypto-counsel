...
- **RAG-powered answers** — a local `corpus.json` (294 entries: 97 algorithms, 195 demo cards, 2 reference docs) is searched at query time with TF-IDF scoring and hand-tuned synonym expansion; the top matches are injected into the system prompt for grounded responses.
...
corpus.json         RAG corpus — 294 entries:
                      97 algorithm entries
                      194 crypto-lab demo cards + 1 standalone demo (snow2)
