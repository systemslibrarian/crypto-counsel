...
- **RAG-powered answers** — a local `corpus.json` (278 entries: 97 algorithms, 179 demo cards, 2 reference docs) is searched at query time with TF-IDF scoring and hand-tuned synonym expansion; the top matches are injected into the system prompt for grounded responses.
...
corpus.json         RAG corpus — 278 entries:
                      97 algorithm entries
                      178 crypto-lab demo cards + 1 standalone demo (snow2)
