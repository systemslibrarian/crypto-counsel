...
- **RAG-powered answers** — a local `corpus.json` (258 entries: 97 algorithms, 159 demo cards, 2 reference docs) is searched at query time with TF-IDF scoring and hand-tuned synonym expansion; the top matches are injected into the system prompt for grounded responses.
...
corpus.json         RAG corpus — 258 entries:
                      97 algorithm entries
                      157 crypto-lab demo cards + 2 standalone demos (snow2, dad-mode-morse2)
